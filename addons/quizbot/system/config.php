		...
		<div class="config_section">
			<div class="setting_element ">
				...
				<select id="set_quiz_status">
					<?php echo activated($data['custom2']); ?>
				</select>
			</div>
			<div class="setting_element ">
			...
			<button id="save_quizbot" onclick="saveQuizbot();" type="button" class="clear_top reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
			<button id="reset_quizbot" onclick="resetScore();" type="button" class="clear_top reg_button default_btn"><i class="fa fa-eraser"></i> <?php echo $lang['reset_score']; ?></button>
		</div>
		<div class="config_section">
