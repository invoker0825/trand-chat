...
<div class="modal_top_live">
	...
	<div id="frame_show_chat" class="modal_top_element">
	...
	<div class="modal_top_element">
		<i id="hide_custom_live" onclick="hideBoxLive();" class="fa fa-minus"></i>
	</div>
